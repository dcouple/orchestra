...
- Run the zone's review lanes over the PR diff (zones 0–2: both reviewers;
  ...
  head-on about a Must Fix, one round of the `dialectic` skill adjudicates
  before you rule. Loop findings back to the matching implementer and push the fixes;
