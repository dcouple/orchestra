...
- **Codex wizard**: `codex` skill role `idea-wizard` (`gpt-5.6-sol` / `low`,
  read-only).
- Both follow `.references/agents/idea-wizard/instructions.md` (stack-neutral)
  and write the formats in `.references/agents/idea-wizard/idea-wizard-output.md`.
