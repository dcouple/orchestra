...
**6. Recheck after fixes.** Stop once the diagram accurately conveys the change,
all text is readable, and the render has no clipping, overlap, or incorrect
connections. Another iteration needs a concrete defect; a clean render needs
no minimum number of passes.
