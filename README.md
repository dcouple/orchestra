...
|---|---|---|
| `claude/skills/` | Claude Code workflow skills (`/do`, `/create-brief`, `/discussion`, `/investigate`, `/prepare-pull-request`, `postmortem`, `postmortem-loop`, `sentry-loop`, `codex`, `excalidraw-pr-diagrams`, `cold-read`, `audit`) | `.claude/skills/` |
