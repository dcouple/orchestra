...
|---|---|---|
| `claude/skills/` | Claude Code workflow skills (`/do`, `/create-brief`, `/discussion`, `/prepare-pull-request`, `/linear-work-orchestrator`, `postmortem`, `codex`, `excalidraw-pr-diagrams`, `cold-read`) | `.claude/skills/` |
