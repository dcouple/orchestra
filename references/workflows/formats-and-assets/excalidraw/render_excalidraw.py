...
def render(
    ...
    try:
        ...
        print("Run: cd .references/workflows/formats-and-assets/excalidraw && uv sync && uv run playwright install chromium", file=sys.stderr)
        sys.exit(1)
    ...
    with sync_playwright() as p:
        try:
            ...
            if "Executable doesn't exist" in str(e) or "browserType.launch" in str(e):
                ...
                print("Run: cd .references/workflows/formats-and-assets/excalidraw && uv run playwright install chromium", file=sys.stderr)
                sys.exit(1)
            raise
